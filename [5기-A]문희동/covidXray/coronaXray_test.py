...
parser.add_argument('--dataDir', type=str, default='KDT_AI_project_competition_study/d반/data/covidXrayData')
parser.add_argument('--weightDir', type=str, default='result_exp/resultWeight_trainingCOVIDXrayData_230404_032601_covidXrayData_OR/mobileNet_epoch_2.pt')
